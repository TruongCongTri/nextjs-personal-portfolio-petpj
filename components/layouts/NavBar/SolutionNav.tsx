...
import NavListTwo from "./NavUtils/NavListTwo";
...
const SolutionNav = () => {
  ...
  return (
    <li onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
      ...
      >
        <div className="lg:border-b-[1px] border-neutral-200 mb-4 pb-4 pt-4 w-full">
        ...
        <div className="lg:border-b-[1px] border-neutral-200 mb-4 pb-4 pt-2 w-full">
