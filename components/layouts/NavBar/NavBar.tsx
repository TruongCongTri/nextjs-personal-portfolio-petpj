    ...
    <Container>
      <div className="text-white bg-transparent py-5">
        <div className="flex items-center max-lg:justify-between max-lg:flex-row-reverse">
          {/* logo icon and buttons for mobile mode */}
              ...
              <div className="lg:flex items-center max-lg:flex-col lg:px-0 px-3 mb:3 lg:mb-0 text-left lg:space-x-4">
                <div className="lg:flex mb-2 lg:mb-0 relative max-lg:mr-4">
                  <input
                    ...
                    className="glass max-lg:bg-neutral-50 max-lg:w-full w-[240px] lg:px-2 h-[38px] max-lg:h-[41px] p-[3.5px] whitespace-nowrap overflow-hidden placeholder:text-[14px] max-lg:placeholder:text-[16px] font-medium placeholder:pl-2 focus:z-10 text-[14px] focus:outline-none focus:bg-white focus:text-black border-[1px] lg:border-neutral-500 max-lg:border-neutral-300 rounded-md lg:focus:text-white "
                    type="text"
                  />
                  <svg
