...
const Hero = () => {
  ...
  const [hoveredOther, setHoveredOther] = useState<boolean>(false);

  return (
    <div className="relative max-w-[1280px] mx-auto lg:pt-32 md:px-10 pt-16">
      <Image
        src="https://github.githubassets.com/images/modules/site/home-campaign/hero-drone.webp"
        alt=""
        className="absolute hero-drone top-20 w-1/4 h-auto xl:right-0"
        width={500}
        height={326}
      />
      <div className="flex">
        ...
        <div className="absolute pt-32 mt-28 max-md:px-4 ml-4 md:ml-12">
          <div className="relative md:top-20 mb-[24px]">
            ...
            >
              <div className="flex items-center p-3 px-5">
                <Image
                  className="w-auto flex-grow-0 flex-shrink-0 mr-6 max-md:mr-3 scale-110"
                  width={44}
                  height={44}
          ...
          <h1 className="md:mt-24 lg:mt-28 sm=mt-10 relative max-md:mb-5 text-[48px] md:text-[72px] max-sm:leading-60px] max-md:leading-[80px] ld:text-[80px] font-semibold text-white">
          ...
          <div className="flex lg:w-11/12 md:space-x-5 max-md:flex-col">
            <form action="">
              <div className="grid max-md:grid-rows-2 md:grid-cols-2">
                <dl>
                  <dd>
                    <input
                      className="h-12 focus:outline-none max-md:rounded-md md:rounded-s-md right-0 w-full placeholder:text-[16px] pl-3 bg-white"
            ...
            <span className="border-[1px] md:border-l-[1px] border-neutral-700 md:mx-10 mb-3 md:mb-0"></span>
            <Link
              href={``}
            ...
            >
              ...
              <svg
                ...
                className={` arrow-symbol-mktg text-white ml-3 transition ease-in duration-150 ${
                  hoveredOther ? "translate-x-0 " : "-translate-x-1"
                }`}
                width="20"
                height="20"
                viewBox="0 0 16 16"
              ...
              >
                ...
                <path
                  className={` text-white transition ease-in duration-150 ${
                    hoveredOther ? " opacity-100" : "opacity-0 "
                  }`}
                  stroke="currentColor"
                  d="M1.75 8H11"
                  strokeWidth="1.5"
