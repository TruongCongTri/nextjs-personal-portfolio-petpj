...
const Collaboration = () => {
  ...
  const [hoveredAnother, setHoveredAnother] = useState<boolean>(false);
        ...
        <div className="flex justify-between md:space-x-10 max-md:flex-col">
          ...
          >
            <div className="md:flex flex-col  flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 ">
              ...
              <div>
                <Link
                  onMouseEnter={() => setHoveredAnother(true)}
                  onMouseLeave={() => setHoveredAnother(false)}
                  href=""
                  className="py-1 inline-block text-xl text-white font-semibold"
                >
                  ...
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className={` mb-[2px] text-white transition inline-block ml-3 ease-in duration-300  ${
                      hoveredAnother ? "translate-x-0 " : "-translate-x-1"
                    }`}
                    width="20"
                    height="20"
                    viewBox="0 0 16 16"
                  ...
                  >
                    ...
                    <path
                      className={` text-white transition ease-in duration-150 ${
                        hoveredAnother ? " opacity-100" : "opacity-0 "
                      }`}
                      stroke="currentColor"
                      d="M1.75 8H11"
                      strokeWidth="1.5"
                  ...
                  <div
                    className={` ${
                      hoveredAnother ? "w-11/12 scale-100" : "w-0 scale-0"
                    } origin-left  transition ease-in duration-300 h-[2.5px] bg-white rounded-full`}
                  ></div>
                </Link>
              </div>
        ...
        <div className="md:flex flex-col md:space-y-20 flex-1 py-20 p-10  justify-between">
          ...
          <div>
            ...
            >
              ...
              <div
                className={` ${
                  hoveredOther ? "w-11/12 scale-100" : "w-0 scale-0"
                } origin-left  transition ease-in duration-300 h-[2.5px] bg-white rounded-full`}
              ></div>
            </Link>
          </div>
